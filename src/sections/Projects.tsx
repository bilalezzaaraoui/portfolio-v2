      ...
      results: [
        {
          title:
            language === "en"
              ? "Development of dynamic and responsive user interfaces using React JS, optimizing the user experience with modular and reusable components."
              : "Développement d'interfaces utilisateur dynamiques et réactives en utilisant React JS, optimisant l'expérience utilisateur grâce à des composants modulaires et réutilisables.",
        },
        {
          title:
            language === "en"
              ? "Integration of RESTful API services, enabling efficient communication between the front-end and back-end services."
              : "Intégration de services API RESTful, facilitant une communication efficace entre le front-end et les services back-end.",
        },
        {
          title:
            language === "en"
              ? "Close collaboration with UX/UI teams to translate wireframes into functional and visually appealing front-end solutions"
              : "Collaboration étroite avec les équipes UX/UI pour transposer les maquettes en solutions front-end fonctionnelles et esthétiquement plaisantes.",
        },
      ],
      ...
      <div className="container">
        <SectionHeader
          ...
          title={
            language === "en"
              ? "Featured Projects"
              : "Avec projets répondant à un besoin réel"
          }
          description={
            language === "en"
              ? "See how I transformed concepts into engaging digital experiences."
              : "Voyez avec mes trois derniers projets comment j'ai converti des idées avant-gardistes en solutions efficaces."
          }
        />
